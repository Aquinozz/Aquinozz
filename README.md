...
I am a backend-focused developer with a strong interest in **Python** and scalable systems.  
Passionate about building robust APIs, writing clean, maintainable code, and optimizing database performance.
